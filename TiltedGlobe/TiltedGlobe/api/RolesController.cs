...
namespace TiltedGlobe.Api
{
    ...
    public class RolesController : BaseApiController<IdentityRole, IdentityRole>
    {
	    public RolesController(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
	    {
	    }
        ...
        protected override List<IdentityRole> Entities
        {
            get { throw new NotImplementedException(); }
        }

        protected override IEnumerable<IdentityRole> Save(IEnumerable<IdentityRole> model)
        {
